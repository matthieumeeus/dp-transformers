...
python estimate_privacy_synthetic.py --config-name synthetic_dbpedia_prefix_canary +submit=True \
    +name=synthetic_dbpedia_prefix_0_canary_0 \
...
python estimate_privacy_synthetic.py --config-name synthetic_dbpedia_prefix_canary +submit=True \
    +name=synthetic_dbpedia_prefix_0_canary_1 \
    ++canary_config.prefix_length=0 \
...
python estimate_privacy_synthetic.py --config-name synthetic_dbpedia_prefix_canary +submit=True \
    +name=synthetic_dbpedia_prefix_0_canary_2 \
    ++canary_config.prefix_length=0 \
...
python estimate_privacy_synthetic.py --config-name synthetic_dbpedia_prefix_canary +submit=True \
    +name=synthetic_dbpedia_prefix_0_canary_3 \
    ++canary_config.prefix_length=0 \
...
python estimate_privacy_synthetic.py --config-name synthetic_dbpedia_prefix_canary +submit=True \
    +name=synthetic_dbpedia_prefix_0_canary_4 \
    ++canary_config.prefix_length=0 \
...
python estimate_privacy_synthetic.py --config-name synthetic_dbpedia_prefix_canary +submit=True \
    +name=synthetic_dbpedia_prefix_0_canary_5 \
    ++canary_config.prefix_length=0 \
...
python estimate_privacy_synthetic.py --config-name synthetic_dbpedia_prefix_canary +submit=True \
    +name=synthetic_dbpedia_prefix_0_canary_6 \
    ++canary_config.prefix_length=0 \
...
python estimate_privacy_synthetic.py --config-name synthetic_dbpedia_prefix_canary +submit=True \
    +name=synthetic_dbpedia_prefix_0_canary_7 \
    ++canary_config.prefix_length=0 \
...
python estimate_privacy_synthetic.py --config-name synthetic_dbpedia_prefix_canary +submit=True \
    +name=synthetic_dbpedia_prefix_0_canary_8 \
    ++canary_config.prefix_length=0 \
